...
import es.sm2.openppm.core.dao.ProjectassociationDAO;
import es.sm2.openppm.core.dao.ProjectcalendarDAO;
import es.sm2.openppm.core.dao.ProjectfundingsourceDAO;
...
public class ProjectLogic extends AbstractGenericLogic<Project, Integer> {
	...
	public List<String> saveInitiatingProject(Project proj, Projectcharter projCharter,
			JSONArray leadsJSON, JSONArray dependentsJSON, Date newPlannedInitDate) throws Exception {
		...
		try {
			...
			newInfo = saveInitiatingProject(session, proj, projCharter, leadsJSON, dependentsJSON, newPlannedInitDate);
	 ...
	 * @throws Exception
	 */
	public List<ProjectWrap> findProjects(ProjectFilter filter) throws Exception {
	 ...
	 * @throws Exception 
	 */
	public List<ProjectWrap> findProjectsForExecutiveReport(ProjectFilter filter) throws Exception {
