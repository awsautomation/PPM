...
public enum PaymentProjectAction implements SecurityAction {
    ...
    PAYMENT_PROJECTS(new SecurityContainer(Constants.ROLE_PMO)),
    JX_CONSULT_SELLERS(new SecurityContainer(Constants.ROLE_PMO)),
    JX_ADD_PAYMENT(new SecurityContainer(Constants.ROLE_PMO)),
    JX_CONSULT_DOCUMENTS(new SecurityContainer(Constants.ROLE_PMO));
