...
public final class Settings {
	...
	public static final String VERSION_APP = notRequired("VERSION_APP", "");
	public static final String VERSION_NAME_APP = notRequired("VERSION_NAME_APP", "");
	public static final String EASTER_EGG = notRequired("EASTER_EGG", "#");
