...
/**
 * Logic object for domain model class Stakeholderclassification
 * @see es.sm2.openppm.logic.Stakeholderclassification
...
public final class StakeholderclassificationLogic extends AbstractGenericLogic<Stakeholderclassification, Integer> {
	...
	public Stakeholderclassification exampleMethod(Stakeholderclassification stakeholderclassification) throws Exception {
	
		if (stakeholderclassification == null) {
			throw new StakeholderclassificationNotFoundException();
		}
		...
		try {
			...
			stakeholderclassification = stakeholderclassificationDAO.exampleMethod(stakeholderclassification);
