...
public class ProjectDAO extends MappingGenericDAO<Project, Integer> {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<ProjectWrap> findProjects(ProjectFilter filter) {
		...
		if (!ValidateUtil.isNull(filter.getPriority())) {
			...
			if (ProjectFilter.GREATHER_EQUAL.equals(filter.getPriority()) && filter.getLastPriority() != null) {
				
				where += FilterUtil.addFilterAnd(where, "p.priority >= :lastPriority ");
			}
			else if (ProjectFilter.LESS_EQUAL.equals(filter.getPriority()) && filter.getLastPriority() != null) {
				
				where += FilterUtil.addFilterAnd(where, "p.priority <= :lastPriority ");
			}
			else if (ProjectFilter.BETWEEN.equals(filter.getPriority()) && filter.getLastPriority() != null && filter.getFirstPriority() != null) {
		...
		if (ValidateUtil.isNotNull(filter.getRiskRating())) {
			...
			if (ProjectFilter.GREATHER_EQUAL.equals(filter.getRiskRating()) && filter.getLastRiskRating() != null) {
				
				where += FilterUtil.addFilterAnd(where, subSelectRiskRating + " >= :lastRiskRating ");
			}
			else if (ProjectFilter.LESS_EQUAL.equals(filter.getRiskRating()) && filter.getLastRiskRating() != null) {
				
				where += FilterUtil.addFilterAnd(where, subSelectRiskRating + " <= :lastRiskRating ");
			}
			else if (ProjectFilter.BETWEEN.equals(filter.getRiskRating()) && filter.getLastRiskRating() != null && filter.getFirstRiskRating() != null) {
		...
		where += FilterUtil.addFilterAnd(filter.getEmployeeByFunctionalManager(), where, "p.employeeByFunctionalManager = :employeeByFunctionalManager ");
		...
		else if (filter.getIncludingAdjustament() != null && !filter.getIncludingAdjustament()) {
		...
		if (!ValidateUtil.isNull(filter.getPriority())) {
			...
			if ((ProjectFilter.GREATHER_EQUAL.equals(filter.getPriority()) || ProjectFilter.LESS_EQUAL.equals(filter.getPriority())) && filter.getLastPriority() != null ) {
		...
		if (ValidateUtil.isNotNull(filter.getRiskRating())) {
			...
			if ((ProjectFilter.GREATHER_EQUAL.equals(filter.getRiskRating()) || ProjectFilter.LESS_EQUAL.equals(filter.getRiskRating())) && filter.getLastRiskRating() != null ) {
		...
		if (filter.getEmployeeByFunctionalManager() != null) { query.setEntity("employeeByFunctionalManager", filter.getEmployeeByFunctionalManager()); }
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<ProjectWrap> findProjectsForExecutiveReport(ProjectFilter filter) {
