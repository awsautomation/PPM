...
public class ProjectPlanServlet extends AbstractGenericServlet {
        ...
        try {
            ...
            if (dateSince != null && dateUntil != null && (periodicity != null || (periodicityCount != -1 && periodicityCount > 0))) {
                ...
                for (Date date : dates) {
                    ...
                    //followup control
                    if (projectFollowupLogic.findByDate(null, new Project(idProject), Projectfollowup.FOLLOWUPDATE, date) == null) {
                        ...
                        followup = projectFollowupLogic.save(followup);
    ...
    private void calculatedPV(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    	...
    	try {
    		ProjectFollowupLogic projectFollowupLogic 	= new ProjectFollowupLogic();
			JSONObject updateJSON 						= new JSONObject();
			JSONObject beforeFollowup 					= new JSONObject();
			JSONObject afterFollowup 					= new JSONObject();
			Double pv									= null;
			...
			updateJSON.put("beforeFollowup", beforeFollowup);
			updateJSON.put("afterFollowup", afterFollowup);
