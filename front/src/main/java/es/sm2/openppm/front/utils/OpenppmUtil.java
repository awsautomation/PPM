...
import es.sm2.openppm.core.logic.setting.VisibilitySetting;
...
public class OpenppmUtil {
	...
	public static int numOfCulumnsForProject(HttpServletRequest req, HashMap<String, String> settings) {
        ...
        if (SettingUtil.getBoolean(settings, VisibilitySetting.PROJECT_COLUMN_CATEGORY)							                                ) { columns++; }
        if (SettingUtil.getBoolean(settings, VisibilitySetting.PROJECT_COLUMN_CLASSIFICATION_LEVEL)							                    ) { columns++; }
