...
<form name="frm_visibility_settings" id="frm_visibility_settings" action="<%=AdministrationServlet.REFERENCE%>" method="post">
	...
	<visual:panel title="${titleColInv }">
		<table width="100%" class="settingTable">
			...
			<tr>
				<td><img class="btitle" title="<fmt:message key="setting.investment.column.poc_info"/>" src="images/info.png"></td>
				<th>
	...
	<visual:panel title="${titleColProj }">
		<table width="100%" class="settingTable">
			...
			<tr>
                ...
                <%-- Visibility settings --%>
                <visual:settings startColumn="3" numberOfColumns="3" fields="<%= VisibilitySetting.values() %>" />
			</tr>
        </table>
	</visual:panel>
