...
<visual:panel title="${titleGeneral}">
    <form name="frm_general_settings" id="frm_general_settings" action="<%=AdministrationServlet.REFERENCE%>" method="post">
        ...
        <table width="100%" cellpadding="5px" class="settingTable">
            <tr>
                <td width="3%"><img class="btitle" title="<fmt:message key="setting.last_level_for_approve_sheet_info"/>" src="images/info.png"></td>
                <th width="25%"><fmt:message key="<%=Settings.SETTING_LAST_LEVEL_FOR_APPROVE_SHEET %>"/></th>
                <td width="20%">
                    <select name="<%=Settings.SETTING_LAST_LEVEL_FOR_APPROVE_SHEET %>" class="campo" style="width:100%;">
                        ...
                        <option value="0" <%=SettingUtil.getString(settings, Settings.SETTING_LAST_LEVEL_FOR_APPROVE_SHEET, Settings.DEFAULT_LAST_LEVEL_FOR_APPROVE_SHEET).equals(String.valueOf(0)) ? "selected" : ""%>>
                ...
                <td width="3%"><img class="btitle" title="<fmt:message key="setting.rm_approve_operation_info"/>" src="images/info.png"></td>
                <th width="25%"><fmt:message key="<%=Settings.SETTING_RESOURCE_MANAGER_APPROVE_OPERATION%>"/></th>
                <td width="20%">
            ...
            <tr>
                ...
                <td width="3%"><img class="btitle" title="<fmt:message key="setting.days_status_report_info"/>" src="images/info.png"></td>
                <th width="25%"><fmt:message key="<%=Settings.SETTING_DAYS_STATUS_REPORT %>"/></th>
                <td width="20%">
            ...
            <%-- General settings --%>
            <visual:settings startColumn="1" numberOfColumns="2" fields="<%= GeneralSetting.values() %>" />
        </table>
