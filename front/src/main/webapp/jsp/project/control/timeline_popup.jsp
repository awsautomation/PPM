...
<c:if test="${op:hasPermission(user,project.status,tab)}">
	<c:set var="buttonsTimeline"><img title="<fmt:message key="view"/>" class="link viewTimeline" src="images/view.png">&nbsp;&nbsp;&nbsp;<img title="<fmt:message key="delete"/>" class="link removeTimeline" src="images/delete.jpg"></c:set>
</c:if>
...
var timeline = {
	view : function() {
        ...
        f.<%=Timeline.NAME%>.value				 		= unEscape(row[5]);
        ...
        $(f.<%=Timeline.DESCRIPTION%>).text(unEscape(row[6]));

		timelinePopup.dialog('open');
	},
	add : function() {
		...
		<fieldset>
			...
			<table border="0" cellpadding="2" cellspacing="1" width="100%">
				<tr>
					...
					<th class="left" width="45%"><fmt:message key="name"/>&nbsp;*</th>
				</tr>
				<tr>
					...
					<td><input type="text" name="<%=Timeline.NAME%>" id="<%=Timeline.NAME %>" maxlength="50" class="campo" /></td>
				</tr>
				<tr>
