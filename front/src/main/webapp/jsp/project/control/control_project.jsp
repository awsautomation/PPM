	...
	<div id="panels" style="padding: 15px;">
		...
		<form name="frm_project" id="frm_project" method="post" >
			...
			<visual:panel id="tb_scope" title="${titleScopeControl }">
				...
				<visual:panel id="content-wbs" title="${titleWbsChart }" cssClass="panel2" buttons="${wbsChartBTN}" callback="wbsChart">
			...
			<visual:panel id="tb_schedule" title="${titleScheduleControl }">
				...
				<visual:panel id="controlGanttChart" title="${titleScheduleChart }" cssClass="panel2">
					...
					<table width="100%" border="0" cellpadding="5" cellspacing="0">
						...
						<c:if test="${op:hasPermission(user,project.status,tab)}">
							...
							<tr>
								...
								<td>
									<textarea rows="3" name="general_desc" style="width: 99%" class="campo statusReport" disabled></textarea>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<th><fmt:message key="desc"/></th>
								<td>
									<textarea rows="3" name="risk_desc" style="width: 99%" class="campo statusReport" disabled></textarea>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<th><fmt:message key="desc"/></th>
								<td>
									<textarea rows="3" name="schedule_desc" style="width: 99%" class="campo statusReport" disabled></textarea>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<th><fmt:message key="desc"/></th>
								<td>
									<textarea rows="3" name="cost_desc" style="width: 99%" class="campo statusReport" disabled></textarea>
								</td>
							</tr>
							<tr>
								<td colspan="4">
