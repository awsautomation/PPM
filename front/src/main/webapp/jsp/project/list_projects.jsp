...
<%@ page import="es.sm2.openppm.core.logic.setting.VisibilitySetting" %>
	...
	if (typeof dataInfoTable === 'undefined') { loadGantt = true; }
		...
		programAjax.call(params, function(data) {
			...
			if (data.noData) {
				...
				$("#chart_gantt").attr("style", "margin: 20px auto; width: 865px;");
...
readyMethods.add(function () {
	...
	projectsTable = $('#tb_projects').dataTable({
		...
		"aoColumns": [ 
                ...
                { "sName":"category", "bVisible": <%=Boolean.parseBoolean(SettingUtil.getString(settings, VisibilitySetting.PROJECT_COLUMN_CATEGORY))%>, "sClass": "left",   "sWidth": "10%" },
                { "sName":"classificationLevel", "bVisible": <%=Boolean.parseBoolean(SettingUtil.getString(settings,  VisibilitySetting.PROJECT_COLUMN_CLASSIFICATION_LEVEL))%>, "sClass": "left",   "sWidth": "10%" },
		...
		<table id="tb_projects" class="tabledata" cellspacing="1" width="100%">
			<thead>
				<tr>
					...
					<th><fmt:message key="followup.actual_cost" /></th>
